...
//
module.exports = {
  createCronJob: (cooker)=>{
    var createAt = cooker.createdAt
    ...
    new CronJob(`${second} ${minute} ${hours} ${date} ${month} *`, function() {
      ...
      var job = queue.create('email', {
          title: `New Menu`
        , to: cooker.email
        , massage: `Hi Chef ${cooker.name}, this is new menu with id${cooker.recipe_id} please get ready for tommorow!!!`
      }).save( function(err){
      ...
      function email(job, done) {
        ...
        let mailOptions = {
            from: '"Nugraha nugraha 👻" <foo@blurdybloop.com>', // sender address
